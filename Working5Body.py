...
def Headers(FragmentCombinations, ligand, user_inputs, bq_ligand, blank_ligand, bq_fragment_list, blank_fragment_list):
    ...
    for combo in FragmentCombinations:
        ...
        with open(OutputFile, "w") as outputfile: 
            ...
            # Ligand + Frag1(Bq) + Frag2 + Frag3 + Frag4
            w(LigandHeader)
            w(blank_ligand)
            ...
            # Ligand + Frag1+ Frag2(Bq) + Frag3 + Frag4
            w(LigandHeader)
            w(blank_ligand)
            w(blank_fragment_list[combo[0] - 1])
            ...
            # Ligand + Frag1 + Frag2 + Frag3(Bq) + Frag4
            w(LigandHeader)
            w(blank_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1 + Frag2 + Frag3 + Frag4(Bq)
            w(LigandHeader)
            w(blank_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            w(blank_fragment_list[combo[2] - 1])
            w(bq_fragment_list[combo[3] - 1])
            w("\n--Link1--\n")   
            
            # Ligand + Frag1(Bq) + Frag2(Bq) + Frag3 + Frag4
            w(LigandHeader)
            w(blank_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1(Bq) + Frag2 + Frag3(Bq) + Frag4
            w(LigandHeader)
            w(blank_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1(Bq) + Frag2 + Frag3 + Frag4(Bq)
            w(LigandHeader)
            w(blank_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1 + Frag2(Bq) + Frag3(Bq) + Frag4
            w(LigandHeader)
            w(blank_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1 + Frag2(Bq) + Frag3 + Frag4(Bq)
            w(LigandHeader)
            w(blank_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1 + Frag2 + Frag3(Bq) + Frag4(Bq)
            w(LigandHeader)
            w(blank_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1(Bq) + Frag2(Bq) + Frag3(Bq) + Frag4
            w(LigandHeader)
            w(blank_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1(Bq) + Frag2 + Frag3(Bq) + Frag4(Bq)
            w(LigandHeader)
            w(blank_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1(Bq) + Frag2(Bq) + Frag3 + Frag4(Bq)
            w(LigandHeader)
            w(blank_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1 + Frag2(Bq) + Frag3(Bq) + Frag4(Bq)
            w(LigandHeader)
            w(blank_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand + Frag1(Bq) + Frag2(Bq) + Frag3(Bq) + Frag4(Bq)
            w(LigandHeader)
            w(blank_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1 + Frag2 + Frag3 + Frag4
            w(TotalHeader)
            w(bq_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1(Bq) + Frag2 + Frag3 + Frag4
            w(LigandHeader)
            w(bq_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1+ Frag2(Bq) + Frag3 + Frag4
            w(LigandHeader)
            w(bq_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1 + Frag2 + Frag3(Bq) + Frag4
            w(LigandHeader)
            w(bq_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1 + Frag2 + Frag3 + Frag4(Bq)
            w(LigandHeader)
            w(bq_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1(Bq) + Frag2(Bq) + Frag3 + Frag4
            w(LigandHeader)
            w(bq_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1(Bq) + Frag2 + Frag3(Bq) + Frag4
            w(LigandHeader)
            w(bq_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1(Bq) + Frag2 + Frag3 + Frag4(Bq)
            w(LigandHeader)
            w(bq_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1 + Frag2(Bq) + Frag3(Bq) + Frag4
            w(LigandHeader)
            w(blank_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1 + Frag2(Bq) + Frag3 + Frag4(Bq)
            w(LigandHeader)
            w(bq_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1 + Frag2 + Frag3(Bq) + Frag4(Bq)
            w(LigandHeader)
            w(bq_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1(Bq) + Frag2(Bq) + Frag3(Bq) + Frag4
            w(LigandHeader)
            w(bq_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1(Bq) + Frag2 + Frag3(Bq) + Frag4(Bq)
            w(LigandHeader)
            w(bq_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(blank_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1(Bq) + Frag2(Bq) + Frag3 + Frag4(Bq)
            w(LigandHeader)
            w(bq_ligand)
            w(bq_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
            ...
            # Ligand(Bq) + Frag1 + Frag2(Bq) + Frag3(Bq) + Frag4(Bq)
            w(LigandHeader)
            w(bq_ligand)
            w(blank_fragment_list[combo[0] - 1])
            w(bq_fragment_list[combo[1] - 1])
