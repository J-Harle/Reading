...
def Headers(FragmentCombinations, ligand, user_inputs, bq_ligand, blank_ligand, bq_fragment_list, blank_fragment_list):
    ...
    for combo in FragmentCombinations:
        ...
        with open(OutputFile, "w") as outputfile: 
            ...
            outputfile.writelines(blank_ligand)
            outputfile.writelines(bq_fragment_list[combo[0] - 1])
            outputfile.writelines(blank_fragment_list[combo[1] - 1])
            outputfile.write("\n--Link1--\n")
            
            # Ligand + Frag1 + Frag2(Bq)
            outputfile.writelines(blank_ligand)
            outputfile.writelines(blank_fragment_list[combo[0] - 1])
            outputfile.writelines(bq_fragment_list[combo[1] - 1])
            outputfile.write("\n--Link1--\n")
